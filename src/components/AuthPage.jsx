  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        await dispatch(registerAsync({ email, passwordHash: password, fullname })).unwrap();
      ...
      alert((isLogin ? "Login" : "Registration") + " Failed: " + (typeof err === 'string' ? err : err?.message || "Ensure Backend is running"));
    }
  };
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-card relative">
          ...
          <div className="max-w-md w-full mx-auto space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <a href="/oauth2/authorization/google" className="flex items-center justify-center gap-2 py-2.5 px-4 bg-bg border border-divider hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl text-text-primary font-medium transition-colors shadow-sm">
