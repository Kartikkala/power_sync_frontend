        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-card relative">
          ...
          <div className="max-w-md w-full mx-auto space-y-8">
            ...
            <a 
              ...
              className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-bg border border-divider hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl text-text-primary font-medium transition-colors shadow-sm"
            >
